...
AGENTS = {
    "12345": {
        ...
        "phone": "9876543210",
        "photo": "https://images.unsplash.com/photo-1527960961181-3c3d7cbbf6c6?auto=format&fit=facearea&w=256&h=256&facepad=2"
    },
    "67890": {
        ...
        "phone": "9123456780",
        "photo": "https://images.unsplash.com/photo-1508214751196-bc5c7bca3d47?auto=format&fit=facearea&w=256&h=256&facepad=2"
    }
}
...
# ------------ Sidebar & Navigation ---------------
st.sidebar.image("https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=200&q=60", width=180)
...
if menu == get_text("🏠 Home", "🏠 होम"):
    ...
    # Replaced broken image with valid Unsplash image
    ...
    if st.button(get_text("Verify Now", "अब सत्यापित करें")) or st.session_state.get("auto_verified"):
        st.session_state.auto_verified = False
    ...
    # Replaced broken image with valid Unsplash image
    st.image("https://images.unsplash.com/photo-1467846876980-bd7d7a1a948c?auto=format&fit=crop&w=400&q=80", use_container_width=True)
    ...
    # Replaced broken image with valid Unsplash image
    st.image("https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=500&q=80", use_container_width=True)
